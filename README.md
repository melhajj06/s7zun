...
Install via [pip](https://pypi.org/project/pip/) using: `pip install git+https://github.com/melhajj06/s7zun@2026.2` (see [this](https://stackoverflow.com/questions/20101834/pip-install-from-git-repo-branch) for more details)\
